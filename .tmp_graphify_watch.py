    ...
    *,
    ...
    try:
        ...
        if not code_files:
            ...
            print(f"[graphify watch] No code files found{scope} - nothing to rebuild.")
            return False
...
def watch(
    ...
    *,
    ...
    config = load_project_config(watch_path)
    ...
    class Handler(FileSystemEventHandler):
        def on_any_event(self, event):
            ...
            if "graphify-out" in path.parts:
                return
            if not path_allowed(path, watch_path, config, profile=active_profile):
                return
    ...
    if active_profile:
        print(f"[graphify watch] Active profile: {active_profile}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--profile", help="Optional graphify profile to apply")
