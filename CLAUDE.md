...
| S10a | Data foundation (core tables) | §16.1-16.3 (core 14 tables), §29.5 (feedback state machine), table relationships in §16 header | #7 (binaries in MinIO, structured in Postgres), #13 (silence not approval) |
